...
Here are all command line parameters available when using ora2pg:
  ...
  Usage: ora2pg [-dhpqv --estimate_cost --dump_as_html] [--option value]
   ...
   --dump_as_csv      : same as above but force ora2pg to dump report in CSV.
...
Here is a sample of report:
	...
	DATABASE LINK 3 0 Database links will be exported as SQL/MED PostgreSQL's Foreign Data Wrapper (FDW) extensions
				using oracle_fdw.
...
date that will be used instead.
...
Migration level: B-5
    ...
    Migration levels:
        ...
        B - Migration that need code rewrite with human-days up to 10 days
        C - Migration that need code rewrite with human-days above 10 days
    Technical levels:
...
directive HUMAN_DAYS_LIMIT to change this default valur permanently.
