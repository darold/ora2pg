...
of cores given as value to ORACLE_COPIES as follow:
	...
	SELECT * FROM MYTABLE WHERE MOD(COLUMN, ORACLE_COPIES) = CUR_PROC
...
is set to 8:
	...
	SELECT * FROM EMPLOYEES WHERE MOD(employee_id, 8) = N
...
as follow in the Kettle XML transformation file:
	...
	<sql>SELECT * FROM HR.EMPLOYEES WHERE MOD(employee_id,${Internal.Step.Unique.Count})=${Internal.Step.Unique.Number}</sql>
