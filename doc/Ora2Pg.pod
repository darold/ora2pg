...
This directive force Ora2Pg to use case sensitivity when scanning the Oracle
database. Enable iit this if you have some object defined with case sensitivity
in your database. Since release 9.1 Ora2Pg is able to auto detect object with
case sensitivity so this directive may be obsoltete. By default it is off.
