...
Since PostgreSQL 9.3, materialized view are supported with the CREATE MATERIALIZED VIEW
syntax, to force Ora2Pg to use the native PostgreSQL support you must enable this
configuration. Disable by default.
