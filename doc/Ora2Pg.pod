...
Features included:
	...
	- Export DBLINK as PostgreSQL FDW.
...
Here are the different values of the TYPE directive, default is TABLE:
	...
	- DBLINK: generate remote foreign data wrapper server to use as dblink
...
will limit export of trigger to those defined on table employees. Or a more
complex form:
