...
Features included:
	...
	- Estimation cost of an Oracle database migration.
	- Estimation cost of PL/SQL migration from external file.
	- Estimation cost of Oracle SQL queries.
...
Old version before 6.0 do not accept any command line parameter than the path to the
configuration file.
...
retesting all Ora2pg functionalities and suggesting lot of improvements.
