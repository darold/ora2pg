...
=head3 Oracle client encryption
...
In the Ora2Pg case, Perl's DBI uses DBD-Oracle, which uses the Oracle client for
...
SHOW_COLUMN allow a new ora2pg command line option: '--xtable relname' or
...
be used with the oracle_fdw foreign data wrapper. By using type FDW your Oracle
...
This directive interact with the TABLE export type to enable or disable the
