...
our @EXCLUDED_TABLES_8I = ('USLOG$_%', 'MLOG$_%', 'RUPD$_%', 'MDXT_%', 'MDRT_%', 'MDRS_%', 'DR$%', 'CLI_SWP$%', 'LOGMNR$%', 'REPCAT$%', 'JAVA$%');
...
sub _get_privilege
{
	...
	$str .= " " . $self->limit_to_objects('GRANT', 'b.GRANTEE');
